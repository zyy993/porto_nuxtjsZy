<template>
              ...
              <div class="card bg-dark text-white">
                <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/img/zy.jpg" alt="Admin" class="rounded-circle" width="150">
                        <div class="mt-3">
                            <h4>Zy</h4>
                            <p class="text-secondary mb-1">Frontend Developer</p>
                            <p class="text-muted font-size-sm">Nglarang, Sleman, Yogyakarta</p>
  ...
  <ul class="list-group list-group-flush ">
    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap bg-dark">
      <h6 class="mb-0">
      ...
      <span class="text-secondary">https://zyy.com</span>
    </li>
    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap bg-dark">
      <h6 class="mb-0">
      ...
      <span class="text-secondary">zyy993</span>
    </li>
    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap bg-dark">
      <h6 class="mb-0">
      ...
      <span class="text-secondary">@zyy</span>
    </li>
    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap bg-dark">
      <h6 class="mb-0">
      ...
      <span class="text-secondary">@slmnlfrsy_</span>
    </li>
    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap bg-dark">
      <h6 class="mb-0">
            ...
            <div class="col-md-8">
              <div class="card mb-3 bg-dark">
                <div class="card-body">
                  <div class="row">
                      <div class="col-sm-3">
                        <h6 class="mb-0 text-white" style="opacity: 0.8;">Full Name</h6>
                      </div>

                    <div class="col-sm-9 text-white" style="opacity: 0.7;">
                      SALMAN AL FARISY
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0 text-white" style="opacity: 0.7;">Email</h6>
                    </div>
                    <div class="col-sm-9 text-white" style="opacity: 0.7;">
                      salmanalfarisy4707@students.amikom.ac.id
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0 text-white" style="opacity: 0.7;">Phone</h6>
                    </div>
                    <div class="col-sm-9 text-white" style="opacity: 0.7;">
                      (+62) 81292919097
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0 text-white" style="opacity: 0.7;">Hobi</h6>
                    </div>
                    <div class="col-sm-9 text-white" style="opacity: 0.7;">
                      Games, Olahraga
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0 text-white" style="opacity: 0.7;">Address</h6>
                    </div>
                    <div class="col-sm-9 text-white" style="opacity: 0.7;">
                      Nusa Tenggara Barat
                    </div>
    ...
    <div class="col-sm-6 mb-3">
        <div class="card h-100 bg-dark text-white" style="opacity: 0.7;">
            <div class="card-body">
                ...
                <div class="progress mb-3" style="height: 5px">
                    <div class="progress-bar bg-pink" role="progressbar" style="width: 72%" aria-valuenow="72" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <small>One Page</small>
                <div class="progress mb-3" style="height: 5px">
                    <div class="progress-bar bg-pink" role="progressbar" style="width: 89%" aria-valuenow="89" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
...
.bg-pink {
    background-color: #fd8791 !important; /* Gunakan !important untuk memastikan warna diterapkan */
}
.list-group-item .text-secondary {
    color: rgb(174, 174, 174) !important;
  }

  .list-group-item h6, .list-group-item span {
