...
`).map(x=>`  ${x}`).join(`
`)}
}`:"";return s.push({name:"useFetch",lang:"javascript",docs:Ce.nuxt.useFetch,code:`const { data, pending, error, refresh } = useFetch('${se.value}'${E})`}),s.push({name:"$fetch",lang:"javascript",docs:Ce.nuxt.$fetch,code:`await $fetch('${se.value}'${E})`}),s}),X=L(Be()),H=me({key:"",value:""}),Me=j(()=>{const s=[];return q.value.length&&s.push({name:"Params",slug:"params",length:q.value.length}),s.push({name:"Query",slug:"query",length:k.query.length}),te.value&&s.push({name:"Body",slug:"body",length:k.body.length}),s.push({name:"Headers",slug:"headers",length:k.headers.length}),s.push({name:"Cookies",slug:"cookies",length:X.value.length}),s.push({name:"Snippets",slug:"snippet"}),s});function Be(){return document.cookie.split("; ").map(s=>{const[l,p]=s.split("=");return{key:l,value:p}}).filter(s=>s.key)}function de(s,l){if(!s)return;const p=X.value.find(x=>x.key===s),E=Ot(s);p!==void 0?l===void 0&&(X.value=X.value.filter(x=>x.key!==s)):(X.value.push({key:s,value:l}),H.key="",H.value=""),E.value=l}lt(()=>{W.value==="json"&&typeof V.value=="string"&&(V.value=JSON.parse(V.value))});const pe=it("nuxt-devtools:server-routes:inputs",()=>[],{window:window.parent});ut([k,f],()=>{const s=pe.value?.find(l=>l.path===n.route.filepath);if(s){f.value||(f.value=s.tab),s.tab!==f.value&&(s.tab=f.value);const{body:l,query:p,headers:E,params:x}=s.inputs;Object.assign(k,{body:l,query:p,headers:E}),R.value=x}else{const l={path:n.route.filepath,tab:q.value.length?"params":"query",inputs:{...k,...q.value.length?{params:R.value}:{}}};pe.value.push(l),f.value||(f.value=l.tab)}},{immediate:!0,deep:!0,debounce:500});function Fe(){pe.value=[],k.body=[],k.query=[],k.headers=[],R.value={},f.value=q.value.length?"params":"query"}const ze=ct();return(s,l)=>{const p=Ue,E=kt,x=ft,A=Re,we=Le,He=wt,Ge=Oe,Je=mt,fe=Ne,We=Ct,Ke=xt,ae=Ve("tooltip");return i(),b("div",qt,[c("div",At,[c("div",Mt,[s.route.method?(i(),S(p,{key:0,class:B(["n-badge-base n-sm",("getRequestMethodClass"in s?s.getRequestMethodClass:e(le))(e(g))]),"pointer-events-none":"","font-mono":"",tabindex:"-1"},{default:C(()=>[Q(U(e(g).toUpperCase()),1)]),_:1},8,["class"])):(i(),S(E,{key:1,modelValue:e(g),"onUpdate:modelValue":l[0]||(l[0]=r=>Z(g)?g.value=r:null),class:B(["n-badge-base n-sm",("getRequestMethodClass"in s?s.getRequestMethodClass:e(le))(e(g))])},{default:C(()=>[(i(),b(N,null,G(ie,r=>c("option",{key:r,class:B(("getRequestMethodClass"in s?s.getRequestMethodClass:e(le))(r))},U(r.toUpperCase()),3)),64))]),_:1},8,["modelValue","class"])),c("div",Bt,[m(x,{"model-value":e(se),readonly:"","flex-auto":"","font-mono":"",p:"x5 y2",n:"sm"},null,8,["model-value"]),c("div",Ft,[ee(m(p,{title:"Copy URL",n:"xs blue",icon:"carbon:copy",border:!1,onClick:l[1]||(l[1]=r=>e(ze)(e(ge),"server-route-url"))},null,512),[[ae,"Copy URL"]]),ee(m(p,{title:"Open in Editor",icon:"carbon-launch",n:"xs blue",border:!1,onClick:l[2]||(l[2]=r=>e($)(s.route.filepath))},null,512),[[ae,"Open in Editor"]])])]),m(p,{"h-full":"",n:"primary solid",onClick:be},{default:C(()=>[m(A,{icon:"carbon:send"})]),_:1})])]),c("div",zt,[(i(!0),b(N,null,G(e(Me),r=>ee((i(),S(p,{key:r.slug,class:B(e(f)===r.slug?"text-primary n-primary":"border-transparent shadow-none"),onClick:Y=>f.value=r.slug},{default:C(()=>[m(A,{icon:("ServerRouteTabIcons"in s?s.ServerRouteTabIcons:e(Pe))[r.slug]},null,8,["icon"]),c("div",Ht,[Q(U(r.name)+" "+U(r?.length?`(${r.length})`:"")+" ",1),c("span",null,U(e(w)[r.slug]?.length?`(${e(w)[r.slug].length})`:""),1)])]),_:2},1032,["class","onClick"])),[[ae,r.name]])),128)),Gt,Jt,m(E,{modelValue:e(J),"onUpdate:modelValue":l[3]||(l[3]=r=>Z(J)?J.value=r:null),class:"n-xs",disabled:!e(_)?.app?.$fetch},{default:C(()=>[Wt,Kt]),_:1},8,["modelValue","disabled"]),ee(m(p,{n:"orange",class:"p-3",icon:"i-carbon-clean",onClick:Fe},null,512),[[ae,"Clear Inputs Saved Cache"]])]),e(f)==="params"?(i(),b("div",Qt,[(i(!0),b(N,null,G(e(q),r=>(i(),b(N,{key:r},[c("div",Xt,U(r),1),m(x,{modelValue:e(R)[r],"onUpdate:modelValue":Y=>e(R)[r]=Y,placeholder:r,"flex-1":""},null,8,["modelValue","onUpdate:modelValue","placeholder"])],64))),128))])):O("",!0),e(f)==="cookies"?(i(),b("div",Yt,[(i(!0),b(N,null,G(e(X),r=>(i(),b("div",{key:r.key,flex:"~ gap-4 items-center"},[m(x,{placeholder:"Key...","model-value":r.key,disabled:"","op-70":""},null,8,["model-value"]),m(x,{placeholder:"Value...","model-value":r.value,"flex-1":"",n:"primary",onInput:Y=>de(r.key,Y.target?.value)},null,8,["model-value","onInput"]),m(p,{title:"Delete",n:"red",onClick:Y=>de(r.key,void 0)},{default:C(()=>[m(A,{icon:"i-carbon-trash-can"})]),_:2},1032,["onClick"])]))),128)),c("div",Zt,[m(x,{modelValue:e(H).key,"onUpdate:modelValue":l[4]||(l[4]=r=>e(H).key=r),placeholder:"Key",n:"primary","flex-1":""},null,8,["modelValue"]),m(x,{modelValue:e(H).value,"onUpdate:modelValue":l[5]||(l[5]=r=>e(H).value=r),placeholder:"Value",n:"primary","flex-1":""},null,8,["modelValue"]),m(p,{title:"Add",n:"primary",onClick:l[6]||(l[6]=r=>de(e(H).key,e(H).value))},{default:C(()=>[m(A,{icon:"i-carbon-save"})]),_:1})])])):O("",!0),m(e(y),null,{default:C(()=>[m(we,{modelValue:e(ne),"onUpdate:modelValue":l[9]||(l[9]=r=>Z(ne)?ne.value=r:null),default:{active:!0,type:"string"},"max-h-xs":"","of-auto":""},{default:C(()=>[e(w)[e(f)]?.length?(i(),b(N,{key:0},[c("div",eo,[to,oo,m(p,{icon:"i-carbon-edit",border:!1,onClick:l[7]||(l[7]=r=>o("open-default-input"))}),no]),m(we,{modelValue:e(w)[e(f)],"onUpdate:modelValue":l[8]||(l[8]=r=>e(w)[e(f)]=r),disabled:"",p0:""},null,8,["modelValue"])],64)):O("",!0)]),_:1},8,["modelValue"])]),_:1}),e(f)==="snippet"?(i(),b("div",so,[e(ke).length?(i(),S(He,{key:0,"code-snippets":e(ke)},null,8,["code-snippets"])):O("",!0)])):e(ne)?(i(),b("div",ao,[e(f)==="body"?(i(),b(N,{key:0},[c("div",ro,[(i(),b(N,null,G(oe,r=>c("button",{key:r,px4:"",py2:"",border:"r base",hover:"bg-active",class:B({"border-b":r!==e(W)}),onClick:Y=>W.value=r},[c("div",{class:B({op30:r!==e(W)}),"font-mono":""},U(r),3)],10,lo)),64)),io]),e(W)==="input"?(i(),S(e(v),{key:0})):e(W)==="json"?(i(),S(e(St),dt({key:1,modelValue:e(V),"onUpdate:modelValue":l[10]||(l[10]=r=>Z(V)?V.value=r:null),class:[e(d)==="dark"?"jse-theme-dark":"light","json-editor-vue of-auto text-sm outline-none"]},s.$attrs,{mode:"text","navigation-bar":!1,indentation:2,"tab-size":2}),null,16,["modelValue","class"])):O("",!0)],64)):(i(),S(e(v),{key:1}))])):O("",!0),e(F)?e(P)?(i(),S(Je,{key:5,"z-10":"","flex-auto":"","backdrop-blur":""},{default:C(()=>[Q(" Fetching... ")]),_:1})):(i(),b(N,{key:6},[c("div",uo,[co,e(u).error?(i(),S(fe,{key:0,n:"red"},{default:C(()=>[Q(" Error ")]),_:1})):O("",!0),m(fe,{n:e(u).error?"orange":"green",textContent:U(e(u).statusCode)},null,8,["n","textContent"]),e(u).contentType?(i(),b("code",po,U(e(u).contentType),1)):O("",!0),e(u).contentType==="application/json"?(i(),S(We,{key:2,getter:()=>({input:e(I)})},null,8,["getter"])):O("",!0),fo,mo,m(fe,{n:"green"},{default:C(()=>[Q(U(e(u).fetchTime)+" ms ",1)]),_:1})]),e(D)==="pdf"?(i(),b("div",vo,[c("div",ho,[c("object",{data:e(I),type:"application/pdf","flex-auto":"",width:"100%",height:"100%",rounded:""},null,8,yo)])])):e(D)!=="media"?(i(),S(Ke,{key:1,"flex-auto":"","overflow-auto":"","py-2":"",code:e(I),lang:e(D)},null,8,["code","lang"])):(i(),b("div",_o,[c("div",go,[e(u).contentType.includes("image")?(i(),b("img",{key:0,rounded:"",src:e(I)},null,8,bo)):(i(),b("video",ko,[c("source",{src:e(I),type:"video/mp4"},null,8,wo)]))])]))],64)):(i(),S(Ge,{key:4},{default:C(()=>[m(p,{n:"primary",onClick:be},{default:C(()=>[m(A,{icon:"carbon:send"}),Q(" Send request ")]),_:1})]),_:1}))])}}}),xo={flex:"~ gap1","text-sm":""},So={key:0,op50:""},To={op50:""},$o=c("span",{op75:""},"Select a route to start",-1),Ro=c("div",{p4:"",border:"b base"},[c("span",{"text-lg":""},"Default Inputs"),c("br"),c("span",{"text-white":"",op50:""},"Merged as default for every request in DevTools")],-1),zo=he({__name:"server-routes",setup(t){const a=L(!1),n=vt(),o=$e(),{selectedRoute:y,view:v,inputDefaults:d}=Ie("serverRoutes"),h=j(()=>{!o.value&&y.value&&(o.value=y.value.filepath);const $=n.value?.find(T=>T.filepath===o.value);return o.value!==y.value?.filepath&&$&&(y.value=$),$}),_=L(""),u=j(()=>new ht(n.value||[],{keys:["method","route"],shouldSort:!0})),D=j(()=>n.value?_.value?u.value.search(_.value).map(T=>T.item):n.value:[]),I=j(()=>{const $=[],T=(g,R)=>{g.routes=g.routes||[],g.routes.push(R)},q=(g,R)=>{const k=R?R.routes?.find(w=>w.route===g):$.find(w=>w.route===g);if(k)return k;const V={route:g,filepath:g.replace(/\W/g,"-").toLowerCase(),type:"collection",routes:[]};return R?T(R,V):$.push(V),V};return D.value.forEach(g=>{let R,k;const V=g.filepath.split("/"),w=V.slice(V.indexOf("server")+1);if(g.type==="runtime"){w[0]="runtime";const z=V.indexOf("dist");z!==-1&&(R=V[z-1],R&&w.splice(1,0,R))}w.length>0&&w[w.length-1].includes(".")&&w.pop(),w.forEach(z=>{k=q(z,k)}),k?T(k,g):$.push(g)}),$});function P(){v.value=v.value==="tree"?"list":"tree"}function F($){return $.charAt(0).toUpperCase()+$.slice(1)}return($,T)=>{const q=Ue,g=bt,R=qe,k=Co,V=gt,w=Oe,z=yt,J=Le,ie=Tt,ue=$t,te=Ve("tooltip");return i(),b(N,null,[m(z,{"storage-key":"tab-server-routes"},{left:C(()=>[m(g,{search:e(_),"onUpdate:search":T[1]||(T[1]=f=>Z(_)?_.value=f:null),pb2:""},{actions:C(()=>[ee(m(q,{"text-lg":"",icon:e(v)==="list"?"i-carbon-list":"i-carbon-tree-view-alt",title:"Toggle view",border:!1,onClick:P},null,8,["icon"]),[[te,"Toggle View"]]),ee(m(q,{"text-lg":"",icon:"i-carbon-cics-sit-overrides",title:"Default Inputs",border:!1,onClick:T[0]||(T[0]=f=>a.value=!e(a))},null,512),[[te,"Default Inputs"]])]),default:C(()=>[c("div",xo,[e(_)?(i(),b("span",So,U(e(D).length)+" matched · ",1)):O("",!0),c("span",To,U(e(n)?.length)+" routes in total",1)])]),_:1},8,["search"]),(i(!0),b(N,null,G(e(v)==="tree"?e(I):e(D),f=>(i(),S(R,{key:f.filepath,item:f},null,8,["item"]))),128))]),right:C(()=>[(i(),S(_t,{max:10},[e(h)?(i(),S(k,{key:e(h).filepath,route:e(h),onOpenDefaultInput:T[2]||(T[2]=f=>a.value=!0)},null,8,["route"])):O("",!0)],1024)),e(h)?O("",!0):(i(),S(w,{key:0},{default:C(()=>[m(V,{px6:"",py2:""},{default:C(()=>[$o]),_:1})]),_:1}))]),_:1}),m(ue,{modelValue:e(a),"onUpdate:modelValue":T[3]||(T[3]=f=>Z(a)?a.value=f:null),"auto-close":"","max-w-xl":"","min-w-xl":"",onClose:T[4]||(T[4]=f=>a.value=!1)},{default:C(()=>[c("div",null,[Ro,(i(!0),b(N,null,G(Object.keys(e(d)),f=>(i(),S(ie,{key:f,text:`${F(f)} ${e(d)[f].length?`(${e(d)[f].length})`:""}`,padding:!1,icon:("ServerRouteTabIcons"in $?$.ServerRouteTabIcons:e(Pe))[f]},{default:C(()=>[m(J,{modelValue:e(d)[f],"onUpdate:modelValue":oe=>e(d)[f]=oe,py0:"",default:{active:!0,type:"string"}},null,8,["modelValue","onUpdate:modelValue"])]),_:2},1032,["text","icon"]))),128))])]),_:1},8,["modelValue"])],64)}}});export{zo as default};
