...
const _imports_0$1 = "" + buildAssetsURL("zy.cvUgzqvh.jpg");
const _sfc_main$4 = {
  name: "HeroSection"
};
...
const _imports_0 = "" + buildAssetsURL("zyy.CQ9nOxgD.jpg");
const _sfc_main$3 = {
  name: "AboutSection"
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></main><footer class="footer"><p> \xA9 <span>${ssrInterpolate($data.currentYear)}</span>. Zyy993. All Rights Reserved. </p></footer></div>`);
}
...
//# sourceMappingURL=index-8cIBAu5Z.mjs.map
